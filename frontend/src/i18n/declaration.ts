...
export enum I18nKey {
  ...
  BRANDING$ATOMS_PLUS = "BRANDING$ATOMS_PLUS",
  BRANDING$ATOMS_PLUS_LOGO = "BRANDING$ATOMS_PLUS_LOGO",
  ...
  CHAT_INTERFACE$MESSAGE_SENT = "CHAT_INTERFACE$MESSAGE_SENT",
  ...
  PLANNER$EMPTY_TITLE = "PLANNER$EMPTY_TITLE",
  PLANNER$EMPTY_DESC = "PLANNER$EMPTY_DESC",
  PLANNER$TIP_COMMAND = "PLANNER$TIP_COMMAND",
  CHANGES$EMPTY_TITLE = "CHANGES$EMPTY_TITLE",
  CHANGES$EMPTY_DESC = "CHANGES$EMPTY_DESC",
  CHANGES$TIP_COMMAND = "CHANGES$TIP_COMMAND",
  ...
  BROWSER$EMPTY_TITLE = "BROWSER$EMPTY_TITLE",
  BROWSER$EMPTY_DESC = "BROWSER$EMPTY_DESC",
  BROWSER$TIP_COMMAND = "BROWSER$TIP_COMMAND",
  ...
  SERVED_APP$NO_SERVER_TITLE = "SERVED_APP$NO_SERVER_TITLE",
  SERVED_APP$NO_SERVER_DESCRIPTION = "SERVED_APP$NO_SERVER_DESCRIPTION",
  SERVED_APP$TIP_PREFIX = "SERVED_APP$TIP_PREFIX",
  SERVED_APP$TIP_COMMAND = "SERVED_APP$TIP_COMMAND",
  SERVED_APP$URL_INPUT = "SERVED_APP$URL_INPUT",
  BUTTON$BACK = "BUTTON$BACK",
  BUTTON$FORWARD = "BUTTON$FORWARD",
  BUTTON$COPY_URL = "BUTTON$COPY_URL",
  ...
  AGENT_STATUS$THINKING = "AGENT_STATUS$THINKING",
  ...
  PREVIEW$NO_FILES = "PREVIEW$NO_FILES",
  PREVIEW$SELECT_FILE = "PREVIEW$SELECT_FILE",
  RACE_MODE$TOGGLE_TOOLTIP = "RACE_MODE$TOGGLE_TOOLTIP",
  RACE_MODE$ENABLED = "RACE_MODE$ENABLED",
  RACE_MODE$DISABLED = "RACE_MODE$DISABLED",
  RACE_MODE$LOADING_MODELS = "RACE_MODE$LOADING_MODELS",
  RACE_MODE$ERROR_LOADING_MODELS = "RACE_MODE$ERROR_LOADING_MODELS",
  RACE_MODE$SELECT_MODELS = "RACE_MODE$SELECT_MODELS",
  RACE_MODE$RACING = "RACE_MODE$RACING",
  RACE_MODE$RESULTS = "RACE_MODE$RESULTS",
  RACE_MODE$MODELS = "RACE_MODE$MODELS",
  RACE_MODE$WINNER = "RACE_MODE$WINNER",
  RACE_MODE$CARDS_VIEW = "RACE_MODE$CARDS_VIEW",
  RACE_MODE$TABLE_VIEW = "RACE_MODE$TABLE_VIEW",
  RACE_MODE$MODEL = "RACE_MODE$MODEL",
  RACE_MODE$TIME = "RACE_MODE$TIME",
  RACE_MODE$TOKENS = "RACE_MODE$TOKENS",
  RACE_MODE$STATUS = "RACE_MODE$STATUS",
  ATOMS$HERO_TITLE_PREFIX = "ATOMS$HERO_TITLE_PREFIX",
  ATOMS$HERO_TITLE_HIGHLIGHT = "ATOMS$HERO_TITLE_HIGHLIGHT",
  ATOMS$HERO_SUBTITLE = "ATOMS$HERO_SUBTITLE",
  ATOMS$INPUT_PLACEHOLDER = "ATOMS$INPUT_PLACEHOLDER",
  ATOMS$BUTTON_START = "ATOMS$BUTTON_START",
  ATOMS$BUTTON_CREATING = "ATOMS$BUTTON_CREATING",
  ATOMS$TEMPLATES_TITLE = "ATOMS$TEMPLATES_TITLE",
  ATOMS$FOOTER_POWERED_BY = "ATOMS$FOOTER_POWERED_BY",
  ATOMS$CATEGORY_SAAS = "ATOMS$CATEGORY_SAAS",
  ATOMS$CATEGORY_ECOMMERCE = "ATOMS$CATEGORY_ECOMMERCE",
  ATOMS$CATEGORY_INTERNAL = "ATOMS$CATEGORY_INTERNAL",
  ATOMS$CATEGORY_PERSONAL = "ATOMS$CATEGORY_PERSONAL",
  ATOMS$TEMPLATE_INVESTMENT_TITLE = "ATOMS$TEMPLATE_INVESTMENT_TITLE",
  ATOMS$TEMPLATE_MANGA_TITLE = "ATOMS$TEMPLATE_MANGA_TITLE",
  ATOMS$TEMPLATE_FITNESS_TITLE = "ATOMS$TEMPLATE_FITNESS_TITLE",
  ATOMS$REMIX_SESSION = "ATOMS$REMIX_SESSION",
  ATOMS$POWERED_BY_OPENSOURCE = "ATOMS$POWERED_BY_OPENSOURCE",
  ATOMS$GITHUB_STARS = "ATOMS$GITHUB_STARS",
  ATOMS$BUILDERS = "ATOMS$BUILDERS",
  ATOMS$TEMPLATE_TODO_TITLE = "ATOMS$TEMPLATE_TODO_TITLE",
  ATOMS$TEMPLATE_TODO_DESC = "ATOMS$TEMPLATE_TODO_DESC",
  ATOMS$TEMPLATE_LANDING_TITLE = "ATOMS$TEMPLATE_LANDING_TITLE",
  ATOMS$TEMPLATE_LANDING_DESC = "ATOMS$TEMPLATE_LANDING_DESC",
  ATOMS$TEMPLATE_DASHBOARD_TITLE = "ATOMS$TEMPLATE_DASHBOARD_TITLE",
  ATOMS$TEMPLATE_DASHBOARD_DESC = "ATOMS$TEMPLATE_DASHBOARD_DESC",
  ATOMS$TEMPLATE_PORTFOLIO_TITLE = "ATOMS$TEMPLATE_PORTFOLIO_TITLE",
  ATOMS$TEMPLATE_PORTFOLIO_DESC = "ATOMS$TEMPLATE_PORTFOLIO_DESC",
  ATOMS$TEMPLATE_ECOMMERCE_TITLE = "ATOMS$TEMPLATE_ECOMMERCE_TITLE",
  ATOMS$TEMPLATE_ECOMMERCE_DESC = "ATOMS$TEMPLATE_ECOMMERCE_DESC",
  ATOMS$TEMPLATE_BLOG_TITLE = "ATOMS$TEMPLATE_BLOG_TITLE",
  ATOMS$TEMPLATE_BLOG_DESC = "ATOMS$TEMPLATE_BLOG_DESC",
  ATOMS$TEMPLATE_ADMIN_PANEL_TITLE = "ATOMS$TEMPLATE_ADMIN_PANEL_TITLE",
  ATOMS$TEMPLATE_EMPLOYEE_PORTAL_TITLE = "ATOMS$TEMPLATE_EMPLOYEE_PORTAL_TITLE",
  ATOMS$TEMPLATE_INVENTORY_SYSTEM_TITLE = "ATOMS$TEMPLATE_INVENTORY_SYSTEM_TITLE",
  ATOMS$TEMPLATE_HR_DASHBOARD_TITLE = "ATOMS$TEMPLATE_HR_DASHBOARD_TITLE",
  ATOMS$STAT_GITHUB_STARS_VALUE = "ATOMS$STAT_GITHUB_STARS_VALUE",
  ATOMS$STAT_BUILDERS_VALUE = "ATOMS$STAT_BUILDERS_VALUE",
  COMMON$WORKING_PROCESS = "COMMON$WORKING_PROCESS",
  COMMON$EDIT_PLANS = "COMMON$EDIT_PLANS",
  COMMON$APPROVE = "COMMON$APPROVE",
  ATOMS$NAV_PRICING = "ATOMS$NAV_PRICING",
  ATOMS$NAV_RESOURCES = "ATOMS$NAV_RESOURCES",
  ATOMS$NAV_LOGIN = "ATOMS$NAV_LOGIN",
  ATOMS$NAV_SIGNUP = "ATOMS$NAV_SIGNUP",
  ATOMS$NAV_BLOG = "ATOMS$NAV_BLOG",
  ATOMS$NAV_USE_CASES = "ATOMS$NAV_USE_CASES",
  ATOMS$NAV_VIDEOS = "ATOMS$NAV_VIDEOS",
  ATOMS$NAV_GITHUB = "ATOMS$NAV_GITHUB",
  ATOMS$HERO_DESCRIPTION = "ATOMS$HERO_DESCRIPTION",
  ATOMS$START_BUTTON = "ATOMS$START_BUTTON",
  ATOMS$PRICING_BADGE = "ATOMS$PRICING_BADGE",
  ATOMS$PRICING_HERO_TITLE = "ATOMS$PRICING_HERO_TITLE",
  ATOMS$PRICING_HERO_SUBTITLE = "ATOMS$PRICING_HERO_SUBTITLE",
  ATOMS$PRICING_FREE_TITLE = "ATOMS$PRICING_FREE_TITLE",
  ATOMS$PRICING_PRO_TITLE = "ATOMS$PRICING_PRO_TITLE",
  ATOMS$PRICING_PRO_BADGE = "ATOMS$PRICING_PRO_BADGE",
  ATOMS$PRICING_MAX_TITLE = "ATOMS$PRICING_MAX_TITLE",
  ATOMS$PRICING_FEATURE_DAILY_5 = "ATOMS$PRICING_FEATURE_DAILY_5",
  ATOMS$PRICING_FEATURE_DAILY_15 = "ATOMS$PRICING_FEATURE_DAILY_15",
  ATOMS$PRICING_FEATURE_MONTHLY_1M = "ATOMS$PRICING_FEATURE_MONTHLY_1M",
  ATOMS$PRICING_FEATURE_MONTHLY_10M = "ATOMS$PRICING_FEATURE_MONTHLY_10M",
  ATOMS$PRICING_FEATURE_MONTHLY_50M = "ATOMS$PRICING_FEATURE_MONTHLY_50M",
  ATOMS$PRICING_FEATURE_STORAGE_1G = "ATOMS$PRICING_FEATURE_STORAGE_1G",
  ATOMS$PRICING_FEATURE_STORAGE_10G = "ATOMS$PRICING_FEATURE_STORAGE_10G",
  ATOMS$PRICING_FEATURE_STORAGE_100G = "ATOMS$PRICING_FEATURE_STORAGE_100G",
  ATOMS$PRICING_FEATURE_RACE_MODE = "ATOMS$PRICING_FEATURE_RACE_MODE",
  ATOMS$PRICING_CTA_FREE = "ATOMS$PRICING_CTA_FREE",
  ATOMS$PRICING_CTA_PRO = "ATOMS$PRICING_CTA_PRO",
  ATOMS$PRICING_CTA_MAX = "ATOMS$PRICING_CTA_MAX",
  ATOMS$RESOURCES_FILTER_ALL = "ATOMS$RESOURCES_FILTER_ALL",
  ATOMS$RESOURCES_USECASES_TITLE = "ATOMS$RESOURCES_USECASES_TITLE",
  ATOMS$RESOURCES_USECASES_SUBTITLE = "ATOMS$RESOURCES_USECASES_SUBTITLE",
  ATOMS$RESOURCES_USECASE_SAAS_TITLE = "ATOMS$RESOURCES_USECASE_SAAS_TITLE",
  ATOMS$RESOURCES_USECASE_SAAS_DESC = "ATOMS$RESOURCES_USECASE_SAAS_DESC",
  ATOMS$RESOURCES_USECASE_ECOMMERCE_TITLE = "ATOMS$RESOURCES_USECASE_ECOMMERCE_TITLE",
  ATOMS$RESOURCES_USECASE_ECOMMERCE_DESC = "ATOMS$RESOURCES_USECASE_ECOMMERCE_DESC",
  ATOMS$RESOURCES_USECASE_DASHBOARD_TITLE = "ATOMS$RESOURCES_USECASE_DASHBOARD_TITLE",
  ATOMS$RESOURCES_USECASE_DASHBOARD_DESC = "ATOMS$RESOURCES_USECASE_DASHBOARD_DESC",
  ATOMS$RESOURCES_USECASE_PORTFOLIO_TITLE = "ATOMS$RESOURCES_USECASE_PORTFOLIO_TITLE",
  ATOMS$RESOURCES_USECASE_PORTFOLIO_DESC = "ATOMS$RESOURCES_USECASE_PORTFOLIO_DESC",
  ATOMS$RESOURCES_USECASE_API_TITLE = "ATOMS$RESOURCES_USECASE_API_TITLE",
  ATOMS$RESOURCES_USECASE_API_DESC = "ATOMS$RESOURCES_USECASE_API_DESC",
  ATOMS$RESOURCES_USECASE_MOBILE_TITLE = "ATOMS$RESOURCES_USECASE_MOBILE_TITLE",
  ATOMS$RESOURCES_USECASE_MOBILE_DESC = "ATOMS$RESOURCES_USECASE_MOBILE_DESC",
  ATOMS$RESOURCES_USECASE_READ_MORE = "ATOMS$RESOURCES_USECASE_READ_MORE",
  ATOMS$RESOURCES_VIDEOS_TITLE = "ATOMS$RESOURCES_VIDEOS_TITLE",
  ATOMS$RESOURCES_VIDEOS_SUBTITLE = "ATOMS$RESOURCES_VIDEOS_SUBTITLE",
  ATOMS$RESOURCES_VIDEOS_FEATURED = "ATOMS$RESOURCES_VIDEOS_FEATURED",
  ATOMS$RESOURCES_VIDEOS_RECENT = "ATOMS$RESOURCES_VIDEOS_RECENT",
  ATOMS$RESOURCES_VIDEO_GETTING_STARTED = "ATOMS$RESOURCES_VIDEO_GETTING_STARTED",
  ATOMS$RESOURCES_VIDEO_BUILD_SAAS = "ATOMS$RESOURCES_VIDEO_BUILD_SAAS",
  ATOMS$RESOURCES_VIDEO_DEPLOY = "ATOMS$RESOURCES_VIDEO_DEPLOY",
  ATOMS$RESOURCES_VIDEO_RACE_MODE = "ATOMS$RESOURCES_VIDEO_RACE_MODE",
  ATOMS$RESOURCES_VIDEO_TEMPLATES = "ATOMS$RESOURCES_VIDEO_TEMPLATES",
  ATOMS$RESOURCES_VIDEO_ADVANCED = "ATOMS$RESOURCES_VIDEO_ADVANCED",
  ATOMS$RESOURCES_BLOG_TITLE = "ATOMS$RESOURCES_BLOG_TITLE",
  ATOMS$RESOURCES_BLOG_SUBTITLE = "ATOMS$RESOURCES_BLOG_SUBTITLE",
  ATOMS$RESOURCES_BLOG_FEATURED = "ATOMS$RESOURCES_BLOG_FEATURED",
  ATOMS$RESOURCES_BLOG_READ_MORE = "ATOMS$RESOURCES_BLOG_READ_MORE",
  ATOMS$RESOURCES_BLOG_RACE_MODE_TITLE = "ATOMS$RESOURCES_BLOG_RACE_MODE_TITLE",
  ATOMS$RESOURCES_BLOG_RACE_MODE_EXCERPT = "ATOMS$RESOURCES_BLOG_RACE_MODE_EXCERPT",
  ATOMS$RESOURCES_BLOG_METAGPT_TITLE = "ATOMS$RESOURCES_BLOG_METAGPT_TITLE",
  ATOMS$RESOURCES_BLOG_METAGPT_EXCERPT = "ATOMS$RESOURCES_BLOG_METAGPT_EXCERPT",
  ATOMS$RESOURCES_BLOG_PRACTICES_TITLE = "ATOMS$RESOURCES_BLOG_PRACTICES_TITLE",
  ATOMS$RESOURCES_BLOG_PRACTICES_EXCERPT = "ATOMS$RESOURCES_BLOG_PRACTICES_EXCERPT",
  ATOMS$RESOURCES_BLOG_FUTURE_TITLE = "ATOMS$RESOURCES_BLOG_FUTURE_TITLE",
  ATOMS$RESOURCES_BLOG_FUTURE_EXCERPT = "ATOMS$RESOURCES_BLOG_FUTURE_EXCERPT",
  STATUS$MESSAGE_RECEIVED = "STATUS$MESSAGE_RECEIVED",
  STATUS$INITIALIZING_AGENT = "STATUS$INITIALIZING_AGENT",
  STATUS$CONNECTING_RUNTIME = "STATUS$CONNECTING_RUNTIME",
  STATUS$CLONING_REPOSITORY = "STATUS$CLONING_REPOSITORY",
  STATUS$LOADING_MICROAGENTS = "STATUS$LOADING_MICROAGENTS",
  STATUS$LOADING_MCP_TOOLS = "STATUS$LOADING_MCP_TOOLS",
  STATUS$PREPARING_WORKSPACE = "STATUS$PREPARING_WORKSPACE",
  STATUS$AGENT_READY = "STATUS$AGENT_READY",
  RUNTIME$BUILDING = "RUNTIME$BUILDING",
  RUNTIME$STARTING = "RUNTIME$STARTING",
  RUNTIME$STARTED = "RUNTIME$STARTED",
  RUNTIME$SETTING_UP_WORKSPACE = "RUNTIME$SETTING_UP_WORKSPACE",
  RUNTIME$SETTING_UP_GIT = "RUNTIME$SETTING_UP_GIT",
  RUNTIME$LOADING_SKILLS = "RUNTIME$LOADING_SKILLS",
  RUNTIME$CONNECTING = "RUNTIME$CONNECTING",
  RUNTIME$LOADING_MICROAGENTS = "RUNTIME$LOADING_MICROAGENTS",
  RUNTIME$LOADING_MCP = "RUNTIME$LOADING_MCP",
  RUNTIME$PREPARING = "RUNTIME$PREPARING",
  RUNTIME$AGENT_READY = "RUNTIME$AGENT_READY",
  RUNTIME$WAITING_SANDBOX = "RUNTIME$WAITING_SANDBOX",
  RUNTIME$INITIALIZING = "RUNTIME$INITIALIZING",
  RUNTIME$YOUR_REQUEST = "RUNTIME$YOUR_REQUEST",
  RUNTIME$PLEASE_WAIT = "RUNTIME$PLEASE_WAIT",
  RUNTIME_TIP$1 = "RUNTIME_TIP$1",
  RUNTIME_TIP$2 = "RUNTIME_TIP$2",
  RUNTIME_TIP$3 = "RUNTIME_TIP$3",
  RUNTIME_TIP$4 = "RUNTIME_TIP$4",
  RUNTIME_TIP$5 = "RUNTIME_TIP$5",
  COMMON$READY = "COMMON$READY",
  CLARIFICATION$TITLE = "CLARIFICATION$TITLE",
  CLARIFICATION$ANSWERED_COUNT = "CLARIFICATION$ANSWERED_COUNT",
  CLARIFICATION$HELP_TEXT = "CLARIFICATION$HELP_TEXT",
  CLARIFICATION$SKIP_ALL = "CLARIFICATION$SKIP_ALL",
  CLARIFICATION$SUBMIT_ANSWERS = "CLARIFICATION$SUBMIT_ANSWERS",
  CLARIFICATION$SKIP_QUESTION = "CLARIFICATION$SKIP_QUESTION",
  CLARIFICATION$AI_SUGGESTION = "CLARIFICATION$AI_SUGGESTION",
  CLARIFICATION$TYPE_ANSWER = "CLARIFICATION$TYPE_ANSWER",
  CLARIFICATION$PRIORITY_CRITICAL = "CLARIFICATION$PRIORITY_CRITICAL",
  CLARIFICATION$PRIORITY_IMPORTANT = "CLARIFICATION$PRIORITY_IMPORTANT",
  CLARIFICATION$PRIORITY_NICE_TO_HAVE = "CLARIFICATION$PRIORITY_NICE_TO_HAVE",
  AUTO_ROLE$RESPONDING = "AUTO_ROLE$RESPONDING",
  AUTO_ROLE$KEYWORDS = "AUTO_ROLE$KEYWORDS",
  AUTO_ROLE$CONFIDENCE = "AUTO_ROLE$CONFIDENCE",
  ATOMS$UNIT_K_PLUS = "ATOMS$UNIT_K_PLUS",
  ATOMS$UNIT_M_PLUS = "ATOMS$UNIT_M_PLUS",
  ATOMS$UNIT_PLUS = "ATOMS$UNIT_PLUS",
  ATOMS$CONTRIBUTORS = "ATOMS$CONTRIBUTORS",
  SETTINGS$SKIP_DEV_MODE = "SETTINGS$SKIP_DEV_MODE",
  TEAM_MODE$TEAM = "TEAM_MODE$TEAM",
  TEAM_MODE$TITLE = "TEAM_MODE$TITLE",
  TEAM_MODE$TOGGLE_LABEL = "TEAM_MODE$TOGGLE_LABEL",
  TEAM_MODE$ACTIVE_TOOLTIP = "TEAM_MODE$ACTIVE_TOOLTIP",
  TEAM_MODE$ENABLE_TOOLTIP = "TEAM_MODE$ENABLE_TOOLTIP",
  TEAM_MODE$ACTIVE_DESCRIPTION = "TEAM_MODE$ACTIVE_DESCRIPTION",
  TEAM_MODE$ENABLE_DESCRIPTION = "TEAM_MODE$ENABLE_DESCRIPTION",
  TEAM_MODE$ERROR_TOOLTIP = "TEAM_MODE$ERROR_TOOLTIP",
  TEAM_MODE$COMPLETED_TOOLTIP = "TEAM_MODE$COMPLETED_TOOLTIP",
  TEAM_MODE$PROGRESS = "TEAM_MODE$PROGRESS",
}
