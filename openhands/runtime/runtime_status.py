...
class RuntimeStatus(Enum):
    ...
    SETTING_UP_SKILLS = 'STATUS$SETTING_UP_SKILLS'
    READY = 'STATUS$READY'
    ERROR = 'STATUS$ERROR'
    ...
    # Progressive initialization status messages for better UX
    MESSAGE_RECEIVED = 'STATUS$MESSAGE_RECEIVED'
    INITIALIZING_AGENT = 'STATUS$INITIALIZING_AGENT'
    CONNECTING_RUNTIME = 'STATUS$CONNECTING_RUNTIME'
    CLONING_REPOSITORY = 'STATUS$CLONING_REPOSITORY'
    LOADING_MICROAGENTS = 'STATUS$LOADING_MICROAGENTS'
    LOADING_MCP_TOOLS = 'STATUS$LOADING_MCP_TOOLS'
    PREPARING_WORKSPACE = 'STATUS$PREPARING_WORKSPACE'
