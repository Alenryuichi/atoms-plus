...
class CodeActAgent(Agent):
    ...
    def _get_tools(self) -> list['ChatCompletionToolParam']:
        ...
        # Atoms Plus: Add delegate_to_role tool for Team Leader coordination
        try:
            from atoms_plus.orchestrator.tools import create_delegate_to_role_tool
            tools.append(create_delegate_to_role_tool())
        except ImportError:
